...
import pt.citi.cs.crdt.benchmarks.TPCW_Riak.entities.AuthorIndex;
import pt.citi.cs.crdt.benchmarks.TPCW_Riak.entities.BestSellerEntry;
import pt.citi.cs.crdt.benchmarks.TPCW_Riak.entities.BestSellerSubject;
import pt.citi.cs.crdt.benchmarks.TPCW_Riak.entities.CCXact;
...
import pt.citi.cs.crdt.benchmarks.TPCW_Riak.entities.SCLine;
import pt.citi.cs.crdt.benchmarks.TPCW_Riak.entities.ShoppingCart;
...
//		WRITE_CONSISTENCY_LEVEL = consistencyLevels[5];
	...
	public String insertAdress() throws Exception {
		...
		pt.citi.cs.crdt.benchmarks.TPCW_Riak.entities.Address address = new Address(
	...
	private Class<?> getEntityClass(String string) {
		...
		try {
			return Class
					.forName("pt.citi.cs.crdt.benchmarks.TPCW_Riak.entities."
							+ className);
